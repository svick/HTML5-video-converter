			...
			Dispatcher.Invoke((Action)(() =>
				{
					...
					TimeSpan remaining = TimeSpan.FromMilliseconds((DateTime.Now - startTime).TotalMilliseconds * (1 - e.Data) / e.Data);
					progressBar.textInfo.Text = "Hotovo: " + e.Data.ToString("P") + ", zbývá " + remaining.ToString();
				}));
		}
